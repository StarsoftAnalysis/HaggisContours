...
func TestTraceContour(t *testing.T) {
	...
	testdata := []testdataT{
		// This is ugly -- could make my own contour-comparing function
		{"tests/test0.png", ContourT{
			{0.4980392156862745, 1}, {1, 0.4980392156862745}, {2, 0.4980392156862745}, {2.5019607843137255, 1}, {2.5019607843137255, 2}, {2, 2.5019607843137255}, {1, 2.5019607843137255}, {0.4980392156862745, 2},
		}, PointT{1, 1}},
