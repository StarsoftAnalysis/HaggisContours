...
func TestTraceContour(t *testing.T) {
	...
	testdata := []testdataT{ // Don't forget that no compression happens for these cases
		...
		{"tests/test4.png", ContourT{
			{0.998, 0.500}, {1.500, -0.500}, {2.002, 0.500}, {2.500, 0.998}, {3.002, 1.500}, {3.002, 2.500}, {2.500, 3.002}, {2.002, 3.500}, {1.500, 4.500}, {0.998, 3.500}, {0.500, 3.002}, {-0.500, 2.500}, {-0.500, 1.500}, {0.500, 0.998}, {0.998, 0.500},
		}, PointT{1, 0}},
	}
...
func TestContourFinder(t *testing.T) {
	...
	testdata := []testdataT{ // Don't forget that no compression happens for these cases
		...
		{"tests/test2.png", ContourS{
			{{-0.500, 0.500}, {0.500, -0.500}, {1.500, -0.500}, {2.002, 0.500}, {1.500, 1.002}, {1.002, 1.500}, {0.500, 2.002}, {-0.500, 1.500}, {-0.500, 0.500}},
			{{2.998, 2.500}, {3.500, 1.998}, {4.500, 2.500}, {4.500, 3.500}, {3.500, 4.500}, {2.500, 4.500}, {1.998, 3.500}, {2.500, 2.998}, {2.998, 2.500}},
		}, 2},
		{"tests/test3.png", ContourS{
			{{0.998, 0.500}, {1.500, -0.500}, {2.500, -0.500}, {3.002, 0.500}, {3.002, 1.500}, {2.500, 2.002}, {2.002, 2.500}, {1.500, 3.002}, {0.500, 3.002},
				{-0.500, 2.500}, {-0.500, 1.500}, {0.500, 0.998}, {0.998, 0.500}},
			{{3.998, 0.500}, {4.500, -0.500}, {5.500, -0.500}, {6.500, -0.500}, {7.500, -0.500}, {8.500, 0.500}, {8.500, 1.500}, {8.500, 2.500}, {8.500, 3.500},
				{8.500, 4.500}, {8.500, 5.500}, {8.500, 6.500}, {8.500, 7.500}, {7.500, 8.500}, {6.500, 8.500}, {5.500, 8.500}, {4.500, 8.500}, {3.500, 8.500},
				{2.500, 8.500}, {1.500, 8.500}, {0.500, 8.500}, {-0.500, 7.500}, {-0.500, 6.500}, {-0.500, 5.500}, {-0.500, 4.500}, {0.500, 3.998}, {1.500, 3.998},
		...
		{"tests/test4.png", ContourS{
			{{0.998, 0.500}, {1.500, -0.500}, {2.002, 0.500}, {2.500, 0.998}, {3.002, 1.500}, {3.002, 2.500}, {2.500, 3.002}, {2.002, 3.500}, {1.500, 4.500},
				{0.998, 3.500}, {0.500, 3.002}, {-0.500, 2.500}, {-0.500, 1.500}, {0.500, 0.998}, {0.998, 0.500}},
			{{3.998, 0.500}, {4.500, -0.500}, {5.500, -0.500}, {6.500, 0.500}, {6.500, 1.500}, {5.500, 2.002}, {4.500, 2.002}, {3.998, 1.500}, {3.998, 0.500}},
			{{3.998, 3.500}, {4.500, 2.998}, {5.002, 3.500}, {4.500, 4.500}, {3.998, 3.500}},
		}, 3},
